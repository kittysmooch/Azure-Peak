...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_CRITICAL_RESISTANCE = span_info("My constitution is iron-clad. My lifeblood flows slowly, blades oft fail to sever limb from body, and grievious wounds are oft averted."),
