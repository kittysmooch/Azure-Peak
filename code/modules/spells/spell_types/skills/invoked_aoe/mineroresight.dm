...
/obj/effect/proc_holder/spell/invoked/mineroresight/cast(list/targets, mob/living/user)
	...
	for(var/turf/closed/mineral/rockturfs in view(7,get_turf(user)))
		...
		if(istype(rockturfs, /turf/closed/mineral/random/rogue/high) || istype(rockturfs, /turf/closed/mineral/rogue/cinnabar) || istype(rockturfs, /turf/closed/mineral/rogue/iron) || istype(rockturfs, /turf/closed/mineral/rogue/gold) || istype(rockturfs, /turf/closed/mineral/rogue/silver) || istype(rockturfs, /turf/closed/mineral/rogue/gem))
