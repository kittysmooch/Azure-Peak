//ported from tg, adapted to roguecode. allows people to print wanted posters from the excidium
...
/obj/item/poster/wanted
	...
	var/postHeaderColor = COLOR_ALMOST_BLACK
	var/background = "wanted_background"
	var/postName = "wanted flyposter"
	var/postDesc = "A wanted flyposter for"

/*/obj/item/poster/wanted/missing //did someone lose their squire? uncomment this if you figure out a purpose for it
...
/obj/structure/sign/poster/wanted/Initialize(mapload, icon/person_icon, person_name, description, postHeaderText, postHeaderColor, background, pname, pdesc)
	...
	the_icon.Insert(icon('icons/roguetown/misc/posters.dmi', "poster_being_set"), "poster_being_set")
	the_icon.Insert(icon('icons/roguetown/misc/posters.dmi', "poster_ripped"), "poster_ripped")
